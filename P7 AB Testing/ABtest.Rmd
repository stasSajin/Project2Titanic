...
Our required sample size is the larger of the two values: **`r rSize`**
...
We didn't find a significant effect for net conversions. The confidence interval of our effect includes the d=0 and dmin=.01. We don't pass the statistical and practical significance thresholds. 
